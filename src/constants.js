export const CHELAKOT = [
  {
    id: "OC",
    label: "אורח חיים",
    english: "Orach Chayim",
    sefaria: "Orach_Chayim",
    simanCount: 697,
  },
  {
    id: "YD",
  ...
  },
  {
    id: "CM",
    label: "חושן משפט",
    english: "Choshen Mishpat",
    sefaria: "Choshen_Mishpat",
    simanCount: 427,
  },
];
...
export const HEBREW_FONTS = [
  {
    ...
    desc: "Traditional",
    family: "'Frank Ruhl Libre', 'Times New Roman', serif",
    url: null,
  },
  {
    id: "noto-serif",
    ...
    desc: "Modern serif",
    family: "'Noto Serif Hebrew', Georgia, serif",
    url: "https://fonts.googleapis.com/css2?family=Noto+Serif+Hebrew:wght@400;500;700&display=swap",
  },
  {
    id: "heebo",
    label: "Heebo",
    ...
    url: "https://fonts.googleapis.com/css2?family=Heebo:wght@400;500;700&display=swap",
  },
  {
    id: "rubik",
    label: "Rubik",
  ...
  },
  {
    ...
    url: "https://fonts.googleapis.com/css2?family=Noto+Sans+Hebrew:wght@400;500;700&display=swap",
  },
  {
    id: "david",
    label: "David Libre",
    desc: "Newspaper",
    family: "'David Libre', Georgia, serif",
    url: "https://fonts.googleapis.com/css2?family=David+Libre:wght@400;700&display=swap",
  },
  {
    id: "suez",
    label: "Suez One",
    desc: "Bold headline",
    family: "'Suez One', Georgia, serif",
  ...
  },
  {
    ...
    label: "Miriam Libre",
    desc: "Classic print",
    family: "'Miriam Libre', Georgia, serif",
